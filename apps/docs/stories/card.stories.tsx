      ...
      <CardContent>
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <span style={{ color: "#ff433d", fontSize: "0.875rem" }}>
              -0.45%
            </span>
          </div>
          <div style={{ display: "flex", justifyContent: "space-between" }}>
      ...
      <CardContent>
        ...
        >
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{ fontSize: "0.875rem", color: "#0068ff" }}>
              Moomss 11.9M
            </div>
          </div>
        </div>
...
export const Interactive: Story = {
  render: () => (
    ...
    >
      ...
      <CardContent>
        <p
          style={{ color: "#666", fontSize: "0.875rem", marginBottom: "2rem" }}
        >
...
export const SmallPadding: Story = {
  args: {
    ...
    children: (
      <div>
        <h4 style={{ marginBottom: "0.25rem", fontSize: "0.875rem" }}>
          Compact Card
        </h4>
  ...
  render: () => (
    ...
    >
      ...
      <Card variant="elevated">
        ...
        <CardContent>
          <p style={{ color: "#ff433d", fontSize: "0.875rem" }}>
            S&P 500: -0.45%
          </p>
          <p style={{ color: "#ff433d", fontSize: "0.875rem" }}>
            NASDAQ: -0.68%
      ...
      <Card variant="elevated">
        ...
        <CardContent>
          ...
          <div style={{ color: "#0068ff", fontSize: "0.75rem" }}>
            Moomss 11.9M
          </div>
        </CardContent>
      </Card>
