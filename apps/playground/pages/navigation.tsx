    ...
    <div style={{ display: 'flex', height: '100vh', width: '100vw', overflow: 'hidden' }}>
      ...
      <main style={{ 
        ...
        <div style={{ 
          ...
          {[
            { symbol: 'AAPL', name: 'Apple Inc.', price: 150.25, change: 2.45, percent: 1.66 },
            { symbol: 'GOOGL', name: 'Alphabet Inc.', price: 2850.75, change: -15.30, percent: -0.53 },
            { symbol: 'MSFT', name: 'Microsoft Corp.', price: 385.50, change: 5.25, percent: 1.38 },
          ].map((stock) => (
            <div 
              key={stock.symbol}
              style={{ 
            ...
            >
              ...
              <div style={{ 
                ...
                {stock.change >= 0 ? '+' : ''}{stock.change.toFixed(2)} ({stock.change >= 0 ? '+' : ''}{stock.percent.toFixed(2)}%)
              </div>
            </div>
          ))}
        </div>
